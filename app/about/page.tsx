...
export default function AboutPage() {
  return <Shell><main id="top"><PageIntro index="01" label="ABOUT THE CLUB / 关于社团" title="因好奇，走到一起。" copy="InfoCo 是西浦计算机社团，开展社课、项目与校园科技活动。" />
    ...
    <section className="closing-cta"><span className="section-index">MEET INFOCO / 9.2</span><h2>9 月 2 日，<br />8 号展位见。</h2><div><a className="btn btn-primary" href="/events/new-member-open-house">查看百团大战 <span>→</span></a><a className="btn btn-ghost" href="/join">加入 InfoCo <span>↗</span></a></div></section>
  </main></Shell>;
}
